...
<main class="min-h-screen bg-background p-4">
  <div class="mx-auto mt-4 w-full max-w-screen-2xl flex flex-col gap-6 lg:flex-row">
          ...
          <Card.Content class="space-y-4 text-sm">
            ...
            <div class="flex items-start justify-between gap-4">
              <p class="flex-1">
                ...
                <span class="text-muted-foreground block">Log time only for the application currently in focus.</span>
              </p>
            ...
            <div class="space-y-2">
              <div class="flex items-start justify-between gap-4">
                <p class="flex-1">
                  ...
                  <span class="text-muted-foreground block">Stop tracking after a period of no mouse or keyboard input.</span>
                </p>
                <Badge variant="secondary">{idleTimeout[0]} min</Badge>
              </div>
              <Slider type="multiple" bind:value={idleTimeout} max={60} min={1} step={1} />
            ...
            <div class="space-y-2">
              <p>
                ...
                <span class="text-muted-foreground block">Applications listed here will not be tracked.</span>
              </p>
          ...
          <Card.Content class="space-y-4 text-sm">
            <div class="flex items-start justify-between gap-4">
              <p class="flex-1">
                ...
                <span class="text-muted-foreground block">Keep all tracking data strictly on this device.</span>
              </p>
            ...
            <div class="flex items-start justify-between gap-4">
              <p class="flex-1">
                ...
                <span class="text-muted-foreground block">Encrypt local database using AES-256.</span>
              </p>
          ...
          <Card.Content class="space-y-3 text-sm">
            <div class="flex items-center justify-between gap-4 rounded-md border p-3">
              <div class="flex items-center gap-3">
                <span class="grid h-9 w-9 place-items-center rounded-full bg-primary/20 text-primary">
                  <Briefcase class="h-4 w-4" />
                </span>
                <p>
                  <span class="font-semibold block">Productive Work</span>
                  <span class="text-muted-foreground block">Target minimum active time</span>
                </p>
              </div>
            ...
            <div class="flex items-center justify-between gap-4 rounded-md border p-3">
              <div class="flex items-center gap-3">
                <span class="grid h-9 w-9 place-items-center rounded-full bg-destructive/20 text-destructive">
                  <Gamepad2 class="h-4 w-4" />
                </span>
                <p>
                  <span class="font-semibold block">Entertainment Limit</span>
                  <span class="text-muted-foreground block">Maximum allowed time</span>
                </p>
              </div>
              <div class="flex items-center gap-2">
          ...
          <Card.Content class="space-y-4 text-sm">
            <div class="flex items-start justify-between gap-4">
              <p class="flex-1">
                ...
                <span class="text-muted-foreground block">Start tracking silently when OS boots.</span>
              </p>
            ...
            <div class="flex items-start justify-between gap-4">
              <p class="flex-1">
                ...
                <span class="text-muted-foreground block">Use GPU for smoother UI rendering.</span>
              </p>
